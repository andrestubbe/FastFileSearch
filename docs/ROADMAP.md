# FastFileSearch Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for file search by aggressively bypassing bottlenecks in standard Java.
